...
from synergine_lifegame.test.src.LifeGameCollectionConfiguration import LifeGameCollectionConfiguration as TestCollectionConfiguration
from synergine_lifegame.test.src.test_context import test_context
